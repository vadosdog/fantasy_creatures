...
Стоимость_уровня = 50 + 10 * ceil(Текущий_уровень / 3)
...
Характеристика = Базовая_характеристика × (1 + 0.03 × (Текущий_уровень - 1))
...
2. **Осколки крафта:**
    - Дроп:
        - В тренировочной комнате: round((количество_существ_противника) × (средний_уровень) × 0.7)
3. **Осколки Памяти**
    - Дроп:
        - PvE-победа
