            ...
            "elemental": [
                {
                    ...
                    "effects": [
                        ...
                        {
                            "required_units": 6,
                            "effect": "При убийстве врага все огненные существа получают +15% атаки на 2 хода"
                        }
                    ]
                },
                {
                    ...
                    "effects": [
                        ...
                        {
                            "required_units": 6,
                            "effect": "Раз в 3 хода водные существа очищают все негативные эффекты"
                        }
                    ]
                },
                {
            ...
            "emotions": [
                {
                    ...
                    "effects": [
                        ...
                        {
                            "required_units": 4,
                            "effect": "При первом убийстве все яростные существа получают +2 к скорости"
                        },
                        {
                            "required_units": 6,
                ...
                },
                {
                    ...
                    "effects": [
                        ...
                        {
                            "required_units": 4,
                            "effect": "При смерти союзника все надеющиеся существа получают +15% защиты"
                        },
                        {
                            "required_units": 6,
