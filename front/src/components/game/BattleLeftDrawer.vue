...
<template>
    ...
    <q-dialog v-model="confirmDelay" persistent class="text-foreground" @show="openDialog" @hide="closeDialog">
        <q-card class="bg-card border backdrop-blur-md">
            <q-card-section class="row items-center">
                <q-avatar icon="fast_forward" class="bg-primary text-background"/>
                <span class="q-ml-sm text-foreground">Вы уверены, что хотите отложить ход до конца раунда?</span>
            </q-card-section>
            ...
            <q-card-actions align="right">
                ...
                <q-btn
                    ...
                    class="bg-primary-gradient text-background mystical-glow"
                    v-close-popup
                    @click="() => battleStore.selectAction('delay')"
                    icon="fast_forward"
                />
            </q-card-actions>
        </q-card>
        ...
        <q-card-section class="row">
          ...
          <span :class="{ 'text-destructive': action.pp > activeCreature.pp }">
            ...
            <q-btn
                ...
                icon="fast_forward"
                label="Отложить"
                :disable="activeCreature.direction === 'left' || !battleStore.canDelayTurn"
            ...
            <q-btn
                ...
                :disable="activeCreature.direction === 'left'"
            />
        </q-card-section>
    </q-card>
</template>
